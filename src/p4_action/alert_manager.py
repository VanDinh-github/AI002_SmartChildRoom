...
class AlertManager:
    def __init__(self):
        ...
        self.alert_history = {}
        self.dedup_interval = DEDUPLICATION_TIME # 30 giây 

    def _calculate_iou(self, bbox1, bbox2):
        """Hàm bổ trợ tính IoU để xác định độ trùng lắp vị trí . Hệ tọa độ trong YOLO trục Y hướng xuống"""
    ...
    def is_duplicate(self, det: DetectionResult) -> bool:
        """
        Node P4.2: Thuật toán lọc trùng cảnh báo .
        """
